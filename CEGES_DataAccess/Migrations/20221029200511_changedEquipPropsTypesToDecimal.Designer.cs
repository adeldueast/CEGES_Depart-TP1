...
namespace CEGES_DataAccess.Migrations
{
    ...
    [Migration("20221029200511_changedEquipPropsTypesToDecimal")]
    partial class changedEquipPropsTypesToDecimal
    {
            ...
            modelBuilder.Entity("CEGES_Models.Rapport", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateDebut = new DateTime(2022, 10, 29, 16, 5, 10, 801, DateTimeKind.Local).AddTicks(5152),
